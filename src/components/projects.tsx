      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {projects.map((project, idx) => (
            ...
            >
              <Card
                className="group bg-black/40 backdrop-blur-md border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-yellow-400/30 flex flex-col h-full overflow-hidden px-2 will-change-transform"
              >
