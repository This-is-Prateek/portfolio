...
export const personalInfo: PersonalInfo = {
  ...
  shortBio:
    'Passionate fullstack developer specializing in modern web technologies. I build responsive, dynamic applications with React, Node.js, and cutting-edge tools. Always learning, always building.',
...
export const projects: Project[] = [
  {
    ...
    description:
      'A sleek personal portfolio built with React, Tailwind, and Three.js featuring an interactive 3D model.',
    img: '/sample.jpg',
  ...
  },
  {
    name: 'Youtube Clone',
    description:
      'A full-stack youtube clone built with Next.js, Tailwind CSS, Node.js, Express, and MongoDB.',
    img: '/sample.jpg',
    ...
    projects: [
      {
        ...
        description:
          'An AI powered content and comment generator for linkedin, twitter and other social media platforms. Worked on the frontend and backend of the marketing website, the main webapp, admin panel and a chrome extension.',
        img: '/sample.jpg',
      ...
      },
      {
        ...
        description:
          'A widget that can be plugged into any website and answer user queries using AI.',
        img: '/sample.jpg',
        technologies: [
          'React',
          'Tailwind CSS',
      ...
      },
      {
        ...
        description:
          'A marketing website built for promoting headless CMS and JAMstack architecture services provided by RaftLabs. Worked on building the website from scratch using Next.js, Tailwind CSS, and Sanity CMS.',
        img: '/sample.jpg',
      ...
      },
      {
        ...
        description:
          'The official website of RaftLabs, to promote the company and its services. Worked on optimizing the website for SEO and performance and maintaining the website including adding new features and fixing bugs.',
        img: '/sample.jpg',
      ...
      },
      {
        name: 'PSI',
        description:
          'A web app used to conduct group discussions on various topics and get insights from the discussions. Worked on maintaining the main webapp and fixing bugs.',
        img: '/sample.jpg',
        link: 'https://psi.tech/',
        technologies: [
          'React',
      ...
      },
      {
        ...
        description:
          'A platform used for earning rewards by scanning product receipts bought from various stores. Worked on frontend and API integration of the main website and the admin panel from scratch.',
        img: '/sample.jpg',
        technologies: [
          'React',
          'Tailwind CSS',
      ...
      },
      {
        ...
        description:
          'A webapp to earn reward points by scanning QR codes of products bought from various stores. Worked on frontend and API integration of the user webapp and the admin.',
        img: '/sample.jpg',
        technologies: [
          'React',
          'Tailwind CSS',
...
export const education: Education[] = [
  ...
  },
  {
    ...
    field: 'Science (PCM)',
    year: '2017 - 2018',
    achievements: ['Secured 76% in the board exams'],
    location: 'Jaipur, Rajasthan',
  },
]
